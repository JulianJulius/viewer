...
TEST_CASE("test_1")
{
        ...
        CHECK_MESSAGE(sizeof(LLGLTFMaterial) == 232, "fields supported for GLTF (sizeof check)");
#endif
#endif
        CHECK_MESSAGE((U32)LLGLTFMaterial::GLTF_TEXTURE_INFO_COUNT == 4, "LLGLTFMaterial texture info count");
